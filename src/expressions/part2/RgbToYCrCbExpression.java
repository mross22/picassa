...
public class RgbToYCrCbExpression extends ParenExpression {
	...
	public RgbToYCrCbExpression(List<Expression> subExpressions, Map<String, Expression> letVariableMap) {
	...
	public RGBColor evaluate(double x, double y) {
		...
		return ColorCombinations.rgbToYCrCb(results.get(0));
	}
	...
	public static class Factory extends ParenExpression.Factory {
		...
		public ParenExpression makeNewParenExpression(List<Expression> subExpressions, Map<String, Expression> letVariableMap) {
			return new RgbToYCrCbExpression(subExpressions, letVariableMap);
		}
