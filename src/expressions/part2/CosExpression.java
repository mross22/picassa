...
public class CosExpression extends ParenExpression {
	...
	public CosExpression(List<Expression> subExpressions, Map<String, Expression> letVariableMap) {
	...
	public RGBColor evaluate(double x, double y) {
		...
		return ColorCombinations.cos(results.get(0));
	}
	...
	public static class Factory extends ParenExpression.Factory {
		...
		public ParenExpression makeNewParenExpression(List<Expression> subExpressions, Map<String, Expression> letVariableMap) {
			return new CosExpression(subExpressions, letVariableMap);
		}
